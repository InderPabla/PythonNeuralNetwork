...
class DataLoader:
    ...
    def __init__(self, data_paths = [], raw_data_filename = "raw_data.txt", size_x = 0, size_y = 0, num_inputs = 0, num_outputs = 0):
    ...
    def load_data(self,path):
        ...
        for i in range(0,images_count):
            ...
            file_name = path+str(i)+'.png' #create file name of get
    ...
    def get_set_elements_to_train(self,index):
        return [np.array(self.input_images_set[index]), 
                ...
                np.array(self.output_reals_set[index])
